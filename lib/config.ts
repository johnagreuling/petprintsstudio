...
export const ART_STYLES = [
  ...
  { id: 'watercolor',      generateStyleId: 'watercolor',        name: 'Watercolor',          emoji: '💧', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/b8df4a7c-cf7e-4a33-b2cf-fbdb3b41ea2f_pet/05ae39e1-c440-4d7a-a376-b91e038af83f.png',     description: 'Delicate washes and soft edges. A luminous, flowing watercolor portrait with the feel of fine art on paper.' },
  ...
  { id: 'pop_art',         generateStyleId: 'bold_contemporary', name: 'Contemporary Bold',   emoji: '⚡', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/b8df4a7c-cf7e-4a33-b2cf-fbdb3b41ea2f_pet/91946181-1e9e-4814-815d-7a5995474b0a.png', description: 'Bold, jewel-toned, and vividly alive. Contemporary graphic energy with a gallery-quality finish.' },
  ...
  { id: 'impressionist',   generateStyleId: 'impressionist',     name: 'Impressionist',       emoji: '🌸', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/b8df4a7c-cf7e-4a33-b2cf-fbdb3b41ea2f_pet/50a2157a-c23d-426c-a93b-a7bc9a5fe237.png',     description: 'Monet-style dappled light and visible brushwork. Color and emotion over precision.' },
  ...
  { id: 'vintage_pop_art', generateStyleId: 'vintage_pop_art',   name: 'Gallery Pop',     emoji: '🎭', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/b8df4a7c-cf7e-4a33-b2cf-fbdb3b41ea2f_pet/31db244e-b5bb-4a0e-8e51-c693724829dc.png',     description: 'Bold single-portrait gallery pop art. Clean graphic shapes, vibrant color blocking, modern gallery energy. Iconic and frame-worthy.' },
  ...
  { id: 'comic_animation', generateStyleId: 'comic_animation',   name: 'Premium Comic',       emoji: '💥', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/b8df4a7c-cf7e-4a33-b2cf-fbdb3b41ea2f_pet/3f911b27-983e-4679-af55-702a6cf2aa7d.png', styleBg: 'linear-gradient(135deg,#1a0505 0%,#2d0a0a 40%,#1a1a2e 70%,#0a0a1a 100%)', styleAccent: '#ff4444', description: 'Bold comic book portrait with clean inked linework, cel shading, cinematic lighting, and vivid animated character energy.' },
