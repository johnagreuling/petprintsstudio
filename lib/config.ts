...
export const ART_STYLES = [
  ...
  { id: 'impasto',         generateStyleId: 'impasto',           name: 'Impasto Expressionism', emoji: '🖌️', styleImage: '',     description: 'Thick palette-knife texture, heavy layered paint, bold broken brush strokes. Modern fine art with a luxury gallery aesthetic.' },
  ...
  { id: 'pastel',          generateStyleId: 'pastel',            name: 'Soft Pastel',         emoji: '🕊️', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/9ed0f1d3-d107-411f-b9de-d42a3f149e10_pet/df586cd0-ccab-4554-848b-a53bf575e56c.png',     description: 'Dreamy pastel chalk on toned paper. Delicate, warm, and deeply tender.' },
  ...
  { id: 'chateau_pop',     generateStyleId: 'chateau_pop',       name: 'Chateau Pop',         emoji: '🪩', styleImage: '/portrait-lily.png', styleBg: 'linear-gradient(135deg,#2a1a2e 0%,#1a2a2a 50%,#2a1a1a 100%)', styleAccent: '#e088a0', description: 'Surreal French interior with disco ball, wingback chair, and painterly birds. Bold impasto texture meets editorial elegance.' },
]
