...
export const ART_STYLES = [
  ...
  { id: 'fairytale',       generateStyleId: 'fairytale',         name: 'Fairytale',           emoji: '✨', styleImage: '/fairytale-mason.png', styleBg: 'linear-gradient(135deg,#1a0a2e 0%,#2d1b4e 40%,#1a2a1a 70%,#0d1a0d 100%)', styleAccent: '#f0c060', description: 'Soft magical storybook portrait with warm golden light, soulful eyes, floating sparkles, and a cozy whimsical scene.' },
