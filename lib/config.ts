...
export const ART_STYLES = [
  ...
  { id: 'vintage_pop_art', generateStyleId: 'vintage_pop_art',   name: 'Gallery Pop',     emoji: '🎭', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/1fec89ea-4a9d-4d4d-9cf9-fbdb3b41ea2f_pet/31db244e-b5bb-4a0e-8e51-c693724829dc.png',     description: 'Bold single-portrait gallery pop art. Clean graphic shapes, vibrant color blocking, modern gallery energy. Iconic and frame-worthy.' },
