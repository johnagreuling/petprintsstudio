...
export const ART_STYLES = [
  { id: 'oil_painting',    generateStyleId: 'ethereal',          name: 'Ethereal Painterly',  emoji: '🎨', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/ec0ac355-9ff6-487b-9bc6-eef33f669445_pet/e5476755-99b5-4117-85e9-e555a855bd13.png', description: 'Soft, dreamlike brushwork with luminous depth. Your pet rendered in a timeless painterly style worthy of any gallery wall.' },
  { id: 'watercolor',      generateStyleId: 'watercolor',        name: 'Watercolor',          emoji: '💧', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/ec0ac355-9ff6-487b-9bc6-eef33f669445_pet/3c7dbde7-52ad-4be9-bb21-46ffebbc1f83.png',     description: 'Delicate washes and soft edges. A luminous, flowing watercolor portrait with the feel of fine art on paper.' },
  { id: 'pencil_sketch',   generateStyleId: 'charcoal',          name: 'Pencil Sketch',       emoji: '✏️', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/ec0ac355-9ff6-487b-9bc6-eef33f669445_pet/8941761a-d2eb-4052-b39c-3f134e277537.png',     description: 'Elegant graphite with expressive line work. Classic, refined, and timeless.' },
  { id: 'pop_art',         generateStyleId: 'bold_contemporary', name: 'Contemporary Bold',   emoji: '⚡', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/ec0ac355-9ff6-487b-9bc6-eef33f669445_pet/74ac54db-2a84-4aae-a6e9-40b8d3f93294.png', description: 'Bold, jewel-toned, and vividly alive. Contemporary graphic energy with a gallery-quality finish.' },
  { id: 'renaissance',     generateStyleId: 'classical_oil',     name: 'Oil Painting',        emoji: '👑', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/ec0ac355-9ff6-487b-9bc6-eef33f669445_pet/0aa0a0e6-fa97-486b-9014-e0debeb7e3dc.png',     description: 'Rich classical oil portrait. Dramatic light, deep color, and Old Masters gravitas.' },
  { id: 'impressionist',   generateStyleId: 'impressionist',     name: 'Impressionist',       emoji: '🌸', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/ec0ac355-9ff6-487b-9bc6-eef33f669445_pet/68c4c0f8-a194-4d5c-9b40-edc6b66e6aac.png',     description: 'Monet-style dappled light and visible brushwork. Color and emotion over precision.' },
  { id: 'pastel',          generateStyleId: 'pastel',            name: 'Soft Pastel',         emoji: '🕊️', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/ec0ac355-9ff6-487b-9bc6-eef33f669445_pet/41f933de-9531-4e2d-941b-1a0f65c786cf.png',     description: 'Dreamy pastel chalk on toned paper. Delicate, warm, and deeply tender.' },
  { id: 'vintage_poster',  generateStyleId: 'vintage_poster',    name: 'Vintage Poster',      emoji: '🗺️', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/ec0ac355-9ff6-487b-9bc6-eef33f669445_pet/51e4b821-d671-492f-98aa-03503f77405f.png',     description: 'Mid-century travel poster energy. Bold graphic composition, flat shapes, nostalgic retro palette.' },
  { id: 'vintage_pop_art', generateStyleId: 'vintage_pop_art',   name: 'Gallery Pop',     emoji: '🎭', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/ec0ac355-9ff6-487b-9bc6-eef33f669445_pet/8bf3c227-e94a-4cc9-b6ae-6f90b5e9b3d0.png',     description: 'Warhol 4-panel screenprint. Same portrait, four bold saturated palettes. Iconic and collectible.' },
  { id: 'vintage_poster_v2', generateStyleId: 'vintage_poster_v2', name: 'Heritage Poster',  emoji: '🏛️', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/ec0ac355-9ff6-487b-9bc6-eef33f669445_pet/03c1c032-703a-4b62-a0ac-c2d6fb11b98a.png',     description: 'Premium retro collectible with badge and sunburst elements. Frame-worthy vintage wall art.' },
  { id: 'neon_glow',       generateStyleId: 'neon_glow',         name: 'Neon Glow',           emoji: '🌟', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/ec0ac355-9ff6-487b-9bc6-eef33f669445_pet/bf527ad9-7827-4804-b0c4-7f4ac63befec.png',     styleBg: 'linear-gradient(135deg,#050510 0%,#150530 50%,#0a1540 100%)', styleAccent: '#a855f7', description: 'Electric, cinematic, high-contrast. Glowing neon outlines on a deep dark background.' },
  { id: 'storybook',       generateStyleId: 'storybook',         name: 'Storybook Nostalgia', emoji: '📖', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/ec0ac355-9ff6-487b-9bc6-eef33f669445_pet/8178b8a8-097f-4c27-ad71-e60df487973a.png',     styleBg: 'linear-gradient(135deg,#1a0f05 0%,#3a1f08 50%,#4a2d10 100%)', styleAccent: '#d4a855', description: 'Warm, cozy, memory-filled. A painterly scene that feels like a cherished illustrated storybook.' },
  { id: 'retro_pop',       generateStyleId: 'retro_pop',         name: 'Retro Pop',           emoji: '🟥', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/sessions/ec0ac355-9ff6-487b-9bc6-eef33f669445_pet/39c8963f-4baa-4e12-8547-79a0c05bdb0a.png',     description: 'Bold four-panel Warhol-style pop art grid. Same portrait, four striking palettes. Iconic, collectible, gallery-worthy.' },
  { id: 'fairytale',       generateStyleId: 'fairytale',         name: 'Fairytale',           emoji: '✨', styleImage: null, styleBg: 'linear-gradient(135deg,#1a0a2e 0%,#2d1b4e 40%,#1a2a1a 70%,#0d1a0d 100%)', styleAccent: '#f0c060', description: 'Soft magical storybook portrait with warm golden light, soulful eyes, floating sparkles, and a cozy whimsical scene.' },
  { id: 'comic_animation', generateStyleId: 'comic_animation',   name: 'Premium Comic',       emoji: '💥', styleImage: null, styleBg: 'linear-gradient(135deg,#1a0505 0%,#2d0a0a 40%,#1a1a2e 70%,#0a0a1a 100%)', styleAccent: '#ff4444', description: 'Bold comic book portrait with clean inked linework, cel shading, cinematic lighting, and vivid animated character energy.' },
  { id: 'fine_art_sketch',  generateStyleId: 'fine_art_sketch',  name: 'Fine Art Sketch',     emoji: '🖊️', styleImage: null, styleBg: 'linear-gradient(135deg,#1a1a14 0%,#2a2a1e 40%,#1e1e18 70%,#141410 100%)', styleAccent: '#c8b89a', description: 'Museum-quality charcoal and graphite portrait on textured paper. Elegant linework, soft crosshatching, and deeply emotional presence.' },
]
