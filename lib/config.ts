...
export const ART_STYLES = [
  ...
  { id: 'pencil_sketch', name: 'Pencil Sketch',    emoji: '✏️', styleImage: 'https://pub-3b7e4ef250914cb9adac3dd43ed84fca.r2.dev/generated/71c31883-de96-4e85-8c14-96f34128e02d.png', styleImage: `${R2}/555126d5-8089-4c20-9ca7-8fb4b6a32811.png`, description: 'Classic graphite, elegant line work',                    prompt: 'detailed pencil sketch of {subject}, fine graphite lines, cross-hatching shading, white background, realistic proportions, expressive eyes, artist sketchbook quality',                                        negPrompt: 'color, photograph, digital art, watermark, text, blurry, low quality' },
